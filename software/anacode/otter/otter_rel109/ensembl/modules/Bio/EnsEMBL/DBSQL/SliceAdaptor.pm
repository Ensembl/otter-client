...
sub store {
  my $self = shift; #warn "self=", Dumper($self), "\n";
  my $slice = shift; #warn "slice", Dumper($slice), "\n";
  my $seqref = shift; #warn "seqref=", Dumper($seqref), "\n";
  my $not_dna = shift; #warn "not_dna=", Dumper($not_dna), "\n";
...
sub store_assembly{
  my $self = shift;
  my $asm_slice = shift; #warn "asm_slice=", Dumper($asm_slice), "\n";
  my $cmp_slice = shift; #warn "cmp_slice=", Dumper($cmp_slice), "\n";
